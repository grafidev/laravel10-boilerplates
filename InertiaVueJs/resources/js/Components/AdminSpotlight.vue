...
const links = [
    { label: 'Clients Cardoil', url: route('dashboard.customers.index') },
    { label: 'Comptes super admins', url: route('dashboard.super_admins.index') },
    { label: 'Roles & permissions', url: route('dashboard.roles.index') },
    { label: 'Configuration', url: route('dashboard.countries.index') },
];
